...
# from ...CommonSupportLib.AppDeviceInformation import DeviceInfoSupport
...
def default_class_fixture(request):
    ...
    driver = BaseDriver(sd.config.remote_appium_server_ip, sd.config.remote_appium_server_port,
                        ...
                        sd.config.ios_mbda_app_package, remote_appium=RemoteAppiumServer)
